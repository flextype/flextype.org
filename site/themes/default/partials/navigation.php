...
<div class="container">
  <a class="navbar-brand" href="<?php echo Url::getBase(); ?>"><h1 class="h1"><img src="<?php echo Url::getBase(); ?>/flexgine-logo-2.jpg" class="site-logo" width=40 /> <b>flextype</b></h1></a>
