    ...
    <div class="inner">
        ...
        <div class="tab-content" id="nav-tabContent">
          <div class="tab-pane text-center fade active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
              <a href="https://github.com/flextype/flextype/releases/tag/v0.9.1" class="btn btn-download"><?= $entry['text']['download_flextype'] ?></a>
              <p>
                  <?= $entry['text']['current_stable_version'] ?> 0.9.1<br>
