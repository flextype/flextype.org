...
txt_features_dynamic_content_types_p: 'Flextype позволяет создать неограниченное количество индивидуальных полей для любых ваших записей.'
txt_features_open_source_heading: 'Свободное ПО'
...
txt_features_built_in_rest_api_p: "Flextype REST API дает вам полный программный контроль над управлением контентом."
...
txt_project_documentation: 'Персональное резюме'
...
txt_no_limits_websites_heading: "Веб-сайты"
txt_no_limits_websites_p: "Бизнес-сайты, Посадочные страницы, Персональный сайт, Портфолио, Каталоги, Блоги и Веб-приложения"
