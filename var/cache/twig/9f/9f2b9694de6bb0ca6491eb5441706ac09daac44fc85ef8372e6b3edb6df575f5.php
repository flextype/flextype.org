...
class __TwigTemplate_f1974586814f4052561ed893b6ad2bd3f84094471dc08987a2ce31c2138736b4 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        // line 1
        return $this->loadTemplate((("themes/" . twig_get_attribute($this->env, $this->source, ($context["registry"] ?? null), "get", [0 => "plugins.site.settings.theme"], "method", false, false, false, 1)) . "/templates/partials/base.html"), "themes/noir-flextype/templates/about.html", 1);
    }
...
";
    ...
    {
        return new Source("", "themes/noir-flextype/templates/about.html", "/Applications/MAMP/htdocs/flextype.org/project/themes/noir-flextype/templates/about.html");
    }
}
