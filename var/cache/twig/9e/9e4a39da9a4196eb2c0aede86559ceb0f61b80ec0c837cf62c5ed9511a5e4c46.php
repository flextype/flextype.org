...
class __TwigTemplate_6b140ad1463bdc6ae281669769d35ed1e8b55c6bbb8aabc5601ae69086b333a3 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        // line 1
        return $this->loadTemplate((("themes/" . twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["registry"] ?? null), "flextype", [], "any", false, false, false, 1), "theme", [], "any", false, false, false, 1)) . "/templates/partials/base.html"), "themes/noir-flextype/templates/default.html", 1);
    }
    ...
    <h1 class=\"uppercase text-center text-3xl lg:text-6xl pl-6 pr-6 lg:pl-40 lg:pr-40 pt-24 pb-24 m-0 font-noirpro-semibold\">
        ";
        // line 6
...
";
    ...
    {
        return new Source("", "themes/noir-flextype/templates/default.html", "/Applications/MAMP/htdocs/flextype.org/site/themes/noir-flextype/templates/default.html");
    }
}
